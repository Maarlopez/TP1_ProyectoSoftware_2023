...
(20, 6, N'https://i.imgur.com/LeQf3gP.jpg', N'Matt Turner, un hombre de negocios estadounidense que vive en Berlín y que se encuentra en una carrera contrarreloj para salvar a su familia y su propia vida.', N'Contrarreloj', N'https://www.youtube.com/watch?v=T7HlHI4S-MY');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'PeliculaId', N'GeneroId', N'Poster', N'Sinopsis', N'Titulo', N'Trailer') AND [object_id] = OBJECT_ID(N'[Peliculas]'))
...
VALUES (N'20230913230050_init', N'7.0.10');
GO
